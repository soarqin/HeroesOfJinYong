...
struct SkillData {
    ...
    std::int16_t damage[::hojy::content::SkillCheckCount], selRange[::hojy::content::SkillCheckCount], area[::hojy::content::SkillCheckCount], addMp[::hojy::content::SkillCheckCount], drainMp[::hojy::content::SkillCheckCount];
};
