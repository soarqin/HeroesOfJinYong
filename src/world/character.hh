...
struct CharacterData {
    ...
    std::int16_t equip[2];
    std::int16_t frame[::hojy::content::CharFrameCount];
    std::int16_t frameDelay[::hojy::content::CharFrameCount];
    std::int16_t frameSoundDelay[::hojy::content::CharFrameCount];
    ...
    std::int16_t skillId[::hojy::content::LearnSkillCount], skillLevel[::hojy::content::LearnSkillCount];
    std::int16_t item[::hojy::content::CarryItemCount], itemCount[::hojy::content::CarryItemCount];
};
