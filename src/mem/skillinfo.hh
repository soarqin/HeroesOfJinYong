...
struct SkillData {
    ...
    std::int16_t damage[data::SkillCheckCount], selRange[data::SkillCheckCount], area[data::SkillCheckCount], addMp[data::SkillCheckCount], drainMp[data::SkillCheckCount];
};
